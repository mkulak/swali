...
declare class SwaggerParser {
     ...
     */
    validate(api: string | OpenAPI.Document, callback: ApiCallback): void;
    validate(api: string | OpenAPI.Document, options: SwaggerParser.Options, callback: ApiCallback): void;
    validate(baseUrl: string, api: string | OpenAPI.Document, options: SwaggerParser.Options, callback: ApiCallback): void;
     ...
     * @param callback (optional) A callback that will receive the dereferenced OpenAPI definition
     */
    static validate(api: string | OpenAPI.Document, callback: ApiCallback): void;
    static validate(api: string | OpenAPI.Document, options: SwaggerParser.Options, callback: ApiCallback): void;
    static validate(baseUrl: string, api: string | OpenAPI.Document, options: SwaggerParser.Options, callback: ApiCallback): void;
     ...
     * @param callback (optional) A callback that will receive the dereferenced OpenAPI definition
     */
    dereference(api: string | OpenAPI.Document, callback: ApiCallback): void;
    dereference(api: string | OpenAPI.Document, options: SwaggerParser.Options, callback: ApiCallback): void;
    dereference(baseUrl: string, api: string | OpenAPI.Document, options: SwaggerParser.Options, callback: ApiCallback): void;
     ...
     * @param callback (optional) A callback that will receive the dereferenced OpenAPI definition
     */
    static dereference(api: string | OpenAPI.Document, callback: ApiCallback): void;
    static dereference(api: string | OpenAPI.Document, options: SwaggerParser.Options, callback: ApiCallback): void;
    static dereference(baseUrl: string, api: string | OpenAPI.Document, options: SwaggerParser.Options, callback: ApiCallback): void;
     ...
     */
    bundle(api: string | OpenAPI.Document, callback: ApiCallback): void;
    bundle(api: string | OpenAPI.Document, options: SwaggerParser.Options, callback: ApiCallback): void;
    bundle(baseUrl: string, api: string | OpenAPI.Document, options: SwaggerParser.Options, callback: ApiCallback): void;
     ...
     * @param callback (optional) A callback that will receive the bundled API definition object
     */
    static bundle(api: string | OpenAPI.Document, callback: ApiCallback): void;
    static bundle(api: string | OpenAPI.Document, options: SwaggerParser.Options, callback: ApiCallback): void;
    static bundle(baseUrl: string, api: string | OpenAPI.Document, options: SwaggerParser.Options, callback: ApiCallback): void;
     ...
     */
    parse(api: string | OpenAPI.Document, callback: ApiCallback): void;
    parse(api: string | OpenAPI.Document, options: SwaggerParser.Options, callback: ApiCallback): void;
    parse(baseUrl: string, api: string | OpenAPI.Document, options: SwaggerParser.Options, callback: ApiCallback): void;
     ...
     * @param callback (optional) A callback that will receive the parsed OpenAPI definition object, or an error
     */
    static parse(api: string | OpenAPI.Document, callback: ApiCallback): void;
    static parse(api: string | OpenAPI.Document, options: SwaggerParser.Options, callback: ApiCallback): void;
